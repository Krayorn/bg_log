            ...
            {!noNav && myPlayerId && (
                <nav className="fixed bottom-0 left-0 right-0">
                    ...
                    <div className="absolute bottom-2 right-3 flex gap-3">
                        {isAdmin && (
                            <Link to="/admin" className="text-slate-500 text-xs hover:text-cyan-400 transition-colors flex items-center gap-1">
                                <Shield className="w-3 h-3" />
                                admin
                            </Link>
                        )}
                        <Link to="/stats" className="text-slate-500 text-xs hover:text-slate-300 transition-colors">
                            stats
                        </Link>
                    ...
                    {results.map((result) => (
                        <Link
                            className={`p-2 rounded-md transition-all ${
                                selected && selected.id === result.id ? 'bg-cyan-500/20 border border-cyan-400/50' : 'hover:bg-slate-700/50'
                            }`}
