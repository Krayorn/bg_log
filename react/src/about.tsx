        ...
        <Layout noNav>
            <div className="max-w-lg mx-auto text-white">
                ...
                <div className="space-y-6 text-slate-300 leading-relaxed">
                    <p>
                        Hi, I'm <span className="text-slate-100 font-medium">Krayorn</span> and I made this website. If you have any feedbacks, ideas
                        or suggestions please send them my way! You can also just send me a message to chat, I'd be delighted!
                    </p>
                    ...
                    <p>
                        ...
                        , and if you like big board games with tons of miniatures, you might be interested in{' '}
                        <a
