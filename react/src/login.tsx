        ...
        <Layout noNav>
            <div className="flex items-center justify-center min-h-[80vh]">
                <section className="bg-slate-900/50 backdrop-blur-sm rounded-lg border border-slate-500/50 overflow-hidden w-80">
                    ...
                    <div className="p-6">
                        {error !== '' && (
                            <div className="mb-4 p-2 rounded bg-red-500/20 border border-red-500/30 text-red-400 text-sm text-center">{error}</div>
                        )}
                        ...
                        <div className="mt-4 pt-4 border-t border-slate-600/30 text-center">
                            <button onClick={toggleMode} className="text-slate-400 text-sm hover:text-cyan-400 transition-colors">
